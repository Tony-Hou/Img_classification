...
items_to_descriptions = {
    'image': 'A 3-channel RGB coloured flower image that is either bathroom, bedroom, floorplan, kitchen, or livingroom  other.',
...
def load_batch(dataset, batch_size, height=image_h, width=image_w, is_training=True):
    '''
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        with sv.managed_session() as sess:
            ...
            #saver.save(sess, "./model_data/estate_model.ckpt")
